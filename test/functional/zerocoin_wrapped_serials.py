...
from fake_stake.base_test import MNSAVINGS_FakeStakeTest

class zMNSCwrappedSerialsTest(MNSAVINGS_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMNSCs..." % DENOM_TO_USE)
