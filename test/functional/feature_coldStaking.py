...
from test_framework.mnsavings_node import mnsavingsTestNode
...
class MNSAVINGS_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(mnsavingsTestNode())
...
if __name__ == '__main__':
    MNSAVINGS_ColdStakingTest().main()
