...
"""Verify that starting mnsc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mnsc with -? for help text")
        ...
        self.log.info("Start mnsc with -version for version information")
