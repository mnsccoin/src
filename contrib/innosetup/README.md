...
* Fill in the following data:
    * Application Name: `mnsc Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The mnsc Developers`
    * Application Website: `https://mnsaving.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `mnsc`
* Add application files:
    * Select the file `mnsc-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `mnsc-2.0.0-win64-setup.exe`
