...
#define MyAppName "mnsc Core"
#define MyAppPublisher "2021-2022 The mnsc Developers"
#define MyAppURL "https://github.com/mnsc/mnsc"
#define MyAppExeName "mnsc-qt.exe"
#define MyAppExtraData "https://github.com/mnsc/mnsc/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\mnsc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\mnsc\mnsc-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\mnsc\mnsc-Qt,strDataDir|{userappdata}\mnsc\}');
  Result := True;
end;
