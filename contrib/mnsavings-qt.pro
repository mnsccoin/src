...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/mnsavings-cli.cpp \
           src/mnsavings-tx.cpp \
           src/mnsavings.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/mnsavings.qrc src/qt/mnsavings_locale.qrc

TRANSLATIONS += src/qt/locale/mnsavings_bg.ts \
                src/qt/locale/mnsavings_de.ts \
                src/qt/locale/mnsavings_en.ts \
                src/qt/locale/mnsavings_es.ts \
                src/qt/locale/mnsavings_fi.ts \
                src/qt/locale/mnsavings_fr.ts \
                src/qt/locale/mnsavings_it.ts \
                src/qt/locale/mnsavings_ja.ts \
                src/qt/locale/mnsavings_pl.ts \
                src/qt/locale/mnsavings_pt.ts \
                src/qt/locale/mnsavings_ru.ts \
                src/qt/locale/mnsavings_sk.ts \
                src/qt/locale/mnsavings_sv.ts \
                src/qt/locale/mnsavings_vi.ts \
                src/qt/locale/mnsavings_zh_CN.ts \
                src/qt/locale/mnsavings_zh_TW.ts
