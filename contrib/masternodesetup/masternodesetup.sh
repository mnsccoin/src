...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mnsc.conf'
CONFIGFOLDER='/root/.mnsc'
COIN_DAEMON='mnscd'
COIN_CLI='mnsc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/mnsc/mnsc/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
