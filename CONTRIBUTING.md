Contributing to mnsc Core
============================

The mnsc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the mnsc Core project, and is not to be
confused with overall mnsc Network Protocol consensus changes.

Whether a pull request is merged into mnsc Core rests with the project merge
...
Patches that change mnsc consensus rules are considerably more involved than
...
Where a patchset proposes to change the mnsc consensus, it must have been
...
The project leader is the release manager for each mnsc Core release.
