...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop MNSAVINGS server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MNSAVINGS server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MNSAVINGS features */
        {"mnsavings", "listmasternodes", &listmasternodes, true, true, false},
        {"mnsavings", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnsavings", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnsavings", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mnsavings", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mnsavings", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mnsavings", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnsavings", "masternodedebug", &masternodedebug, true, true, false},
        {"mnsavings", "startmasternode", &startmasternode, true, true, false},
        {"mnsavings", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnsavings", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnsavings", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnsavings", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnsavings", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnsavings", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnsavings", "preparebudget", &preparebudget, true, true, false},
        {"mnsavings", "submitbudget", &submitbudget, true, true, false},
        {"mnsavings", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mnsavings", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mnsavings", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mnsavings", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mnsavings", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mnsavings", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mnsavings", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnsavings", "checkbudgets", &checkbudgets, true, true, false},
        {"mnsavings", "mnsync", &mnsync, true, true, false},
        {"mnsavings", "spork", &spork, true, true, false},
        {"mnsavings", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> mnsavings-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5726/\n";
}
