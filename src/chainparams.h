 ...
 * MNSAVINGS system. There are three: the main network on which people trade goods
...
public:
    ...
    int mnsavingsBadBlockTime() const { return nmnsavingsBadBlockTime; }
    int mnsavingsBadBlocknBits() const { return nmnsavingsBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nmnsavingsBadBlockTime;
    unsigned int nmnsavingsBadBlocknBits;
