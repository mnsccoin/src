...
/** Utility functions used by the MNSAVINGS Qt UI.
 */
namespace GUIUtil
{
...
// Render MNSAVINGS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmnsc = false);
...
// Parse "mnsavings:" URI into recipient object, return true on successful parsing
