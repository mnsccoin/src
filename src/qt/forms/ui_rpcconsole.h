...
public:
    ...
    QLabel *wallet_customzmnscbackuppath_label;
    QLabel *wallet_customzmnscbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzmnscbackuppath_label = new QLabel(tab_repair);
        wallet_customzmnscbackuppath_label->setObjectName(QStringLiteral("wallet_customzmnscbackuppath_label"));
        wallet_customzmnscbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzmnscbackuppath_label, 4, 0, 1, 1);

        wallet_customzmnscbackuppath = new QLabel(tab_repair);
        wallet_customzmnscbackuppath->setObjectName(QStringLiteral("wallet_customzmnscbackuppath"));
        wallet_customzmnscbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzmnscbackuppath->setVisible(false);
        wallet_customzmnscbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzmnscbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_4->addWidget(wallet_customzmnscbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the MNSAVINGS debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzmnscbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zMNSC Backup Path:", Q_NULLPTR));
        wallet_customzmnscbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
