                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMNSCPathCustom = GetArg("-zmnscbackuppath", "");
    ...
    if(!strzMNSCPathCustom.empty()) {
        ui->wallet_customzmnscbackuppath->setText(QString::fromStdString(strzMNSCPathCustom));
        ui->wallet_customzmnscbackuppath_label->setVisible(true);
        ui->wallet_customzmnscbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMNSCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MNSAVINGS RPC console.") + "<br>" +
