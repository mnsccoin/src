...
#include "qt/mnsavings/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mnsavings/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MNSAVINGSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MNSAVINGSGUI::handleRestart()
