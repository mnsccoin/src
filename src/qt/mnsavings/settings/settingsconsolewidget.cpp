...
#include "qt/mnsavings/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mnsavings/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MNSAVINGSGUI* _window, QWidget *parent) :
