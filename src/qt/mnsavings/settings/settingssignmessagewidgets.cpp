...
#include "qt/mnsavings/settings/settingssignmessagewidgets.h"
#include "qt/mnsavings/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(MNSAVINGSGUI* _window, QWidget *parent) :
