...
public:
    ...
    QSpacerItem *verticalPercentagezmnsc;
    QLabel *labelDivider;
    ...
    void setupUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        verticalPercentagezmnsc = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalPercentagezmnsc);
