...
public:
    ...
    QHBoxLayout *horizontalPercentagezmnsc;
    QLabel *labelTitleUnit;
    QSpacerItem *horizontalSpacerPercentagezmnsc;
    QValueComboBox *comboBoxUnit;
    QSpacerItem *verticalDenomzmnsc;
    QHBoxLayout *horizontalDenomzmnsc;
    QLabel *labelTitleDigits;
    QSpacerItem *horizontalDenomzmnsc_1;
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezmnsc = new QHBoxLayout();
        horizontalPercentagezmnsc->setObjectName(QStringLiteral("horizontalPercentagezmnsc"));
        labelTitleUnit = new QLabel(left);
        labelTitleUnit->setObjectName(QStringLiteral("labelTitleUnit"));

        horizontalPercentagezmnsc->addWidget(labelTitleUnit);

        horizontalSpacerPercentagezmnsc = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalPercentagezmnsc->addItem(horizontalSpacerPercentagezmnsc);
        ...
        horizontalPercentagezmnsc->addWidget(comboBoxUnit);


        verticalLayout_2->addLayout(horizontalPercentagezmnsc);

        verticalDenomzmnsc = new QSpacerItem(20, 10, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalDenomzmnsc);

        horizontalDenomzmnsc = new QHBoxLayout();
        horizontalDenomzmnsc->setObjectName(QStringLiteral("horizontalDenomzmnsc"));
        labelTitleDigits = new QLabel(left);
        labelTitleDigits->setObjectName(QStringLiteral("labelTitleDigits"));

        horizontalDenomzmnsc->addWidget(labelTitleDigits);

        horizontalDenomzmnsc_1 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalDenomzmnsc->addItem(horizontalDenomzmnsc_1);
        ...
        horizontalDenomzmnsc->addWidget(comboBoxDigits);


        verticalLayout_2->addLayout(horizontalDenomzmnsc);
