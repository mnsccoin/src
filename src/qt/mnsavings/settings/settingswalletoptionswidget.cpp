...
#include "qt/mnsavings/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/mnsavings/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MNSAVINGSGUI* _window, QWidget *parent) :
