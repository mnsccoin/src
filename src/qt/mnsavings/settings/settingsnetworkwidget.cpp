...
#include "qt/mnsavings/settings/settingsnetworkwidget.h"
#include "qt/mnsavings/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/mnsavings/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MNSAVINGSGUI* _window, QWidget *parent) :
