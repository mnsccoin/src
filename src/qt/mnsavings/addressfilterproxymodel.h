...
#ifndef MNSAVINGS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MNSAVINGS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MNSAVINGS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
