...
#include "qt/mnsavings/forms/ui_coincontrolmnscwidget.h"

CoinControlmnscWidget::CoinControlmnscWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlmnscWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select MNSC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("MNSC");
    ...
    ui->labelValueAfter->setText("0.00 MNSC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 MNSC");
    ui->labelValueFee->setText("0.00 MNSC");
...
CoinControlmnscWidget::~CoinControlmnscWidget()
{
    delete ui;
}
