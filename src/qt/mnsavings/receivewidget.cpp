...
#include "qt/mnsavings/forms/ui_receivewidget.h"
...
#include "qt/mnsavings/addressholder.h"
...
ReceiveWidget::ReceiveWidget(MNSAVINGSGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive MNSC."));
