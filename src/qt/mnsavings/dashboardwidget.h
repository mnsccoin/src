...
#include "config/mnsavings-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalmnsc = 0;
    qint64 totalZmnsc = 0;
    QList<qreal> valuesmnsc;
    QList<qreal> valueszmnsc;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(MNSAVINGSGUI* _window);
    ~DashboardWidget();
