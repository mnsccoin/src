...
public:
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        comboBoxCoin->setText(QApplication::translate("RequestDialog", "MNSC", Q_NULLPTR));
        ...
        labelAddress->setText(QApplication::translate("RequestDialog", "A7VFR83SQbiezrW72hjcWJtcfip5krte2Z ", Q_NULLPTR));
