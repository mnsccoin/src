...
public:
    ...
    QLabel *labelSquaremnsc;
    QLabel *labelmnsc;
    QSpacerItem *horizontalSpacer_5;
    QLabel *labelSquarezmnsc;
    QLabel *labelZmnsc;
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountmnsc = new QLabel(right);
        labelAmountmnsc->setObjectName(QStringLiteral("labelAmountmnsc"));
        labelAmountmnsc->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountmnsc);

        labelAmountZmnsc = new QLabel(right);
        labelAmountZmnsc->setObjectName(QStringLiteral("labelAmountZmnsc"));
        labelAmountZmnsc->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountZmnsc);
        ...
        labelSquaremnsc = new QLabel(verticalWidgetChart);
        labelSquaremnsc->setObjectName(QStringLiteral("labelSquaremnsc"));
        labelSquaremnsc->setMinimumSize(QSize(14, 14));
        labelSquaremnsc->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquaremnsc);

        labelmnsc = new QLabel(verticalWidgetChart);
        labelmnsc->setObjectName(QStringLiteral("labelmnsc"));

        horizontalLayout_4->addWidget(labelmnsc);

        horizontalSpacer_5 = new QSpacerItem(10, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        horizontalLayout_4->addItem(horizontalSpacer_5);

        labelSquarezmnsc = new QLabel(verticalWidgetChart);
        labelSquarezmnsc->setObjectName(QStringLiteral("labelSquarezmnsc"));
        labelSquarezmnsc->setMinimumSize(QSize(14, 14));
        labelSquarezmnsc->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquarezmnsc);

        labelZmnsc = new QLabel(verticalWidgetChart);
        labelZmnsc->setObjectName(QStringLiteral("labelZmnsc"));

        horizontalLayout_4->addWidget(labelZmnsc);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountmnsc->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelAmountZmnsc->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking statistics", Q_NULLPTR));
        labelSquaremnsc->setText(QString());
        labelmnsc->setText(QApplication::translate("DashboardWidget", "MNSC", Q_NULLPTR));
        labelSquarezmnsc->setText(QString());
        labelZmnsc->setText(QApplication::translate("DashboardWidget", "zMNSC", Q_NULLPTR));
