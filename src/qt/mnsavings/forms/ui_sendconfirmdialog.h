...
"}"));
    ...
    void retranslateUi(QWidget *TxDetailDialog)
    {
        ...
        textSend->setText(QApplication::translate("TxDetailDialog", "A7VFR83SQbiezrW72hjcWJtcfip5krte2Z ", Q_NULLPTR));
        ...
        textAmount->setText(QApplication::translate("TxDetailDialog", "2 MNSC", Q_NULLPTR));
        ...
        textFee->setText(QApplication::translate("TxDetailDialog", "0.0001 MNSC", Q_NULLPTR));
