/********************************************************************************
** Form generated from reading UI file 'coincontrolmnscwidget.ui'
**
...
#ifndef UI_COINCONTROLMNSCWIDGET_H
#define UI_COINCONTROLMNSCWIDGET_H
...
class Ui_CoinControlmnscWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlmnscWidget)
    {
        if (CoinControlmnscWidget->objectName().isEmpty())
            CoinControlmnscWidget->setObjectName(QStringLiteral("CoinControlmnscWidget"));
        CoinControlmnscWidget->resize(918, 552);
        CoinControlmnscWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlmnscWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlmnscWidget);
        ...
        retranslateUi(CoinControlmnscWidget);

        QMetaObject::connectSlotsByName(CoinControlmnscWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlmnscWidget)
    {
        CoinControlmnscWidget->setWindowTitle(QApplication::translate("CoinControlmnscWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlmnscWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlmnscWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlmnscWidget", "MNSC:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlmnscWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlmnscWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlmnscWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlmnscWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlmnscWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlmnscWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlmnscWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlmnscWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlmnscWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlmnscWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlmnscWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlmnscWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlmnscWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlmnscWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlmnscWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlmnscWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlmnscWidget: public Ui_CoinControlmnscWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLMNSCWIDGET_H
