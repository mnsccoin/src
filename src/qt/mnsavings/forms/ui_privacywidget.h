...
public:
    ...
    void setupUi(QWidget *PrivacyWidget)
    {
        ...
        btnTotalzMNSC = new OptionButton(right);
        btnTotalzMNSC->setObjectName(QStringLiteral("btnTotalzMNSC"));
        btnTotalzMNSC->setMinimumSize(QSize(0, 50));

        verticalLayout_5->addWidget(btnTotalzMNSC);
    ...
    void retranslateUi(QWidget *PrivacyWidget)
    {
        ...
        labelEmpty->setText(QApplication::translate("PrivacyWidget", "No active Master Node yet", Q_NULLPTR));
