...
#include "qt/mnsavings/expandablebutton.h"
...
public:
    ...
    QLabel *labelAmountTopmnsc;
    QSpacerItem *horizontalSpacer_11;
    QLabel *label_16;
    QSpacerItem *horizontalSpacer_12;
    QLabel *labelAmountTopzmnsc;
    ...
    QLabel *labelTitle1;
    QLabel *labelAmountmnsc;
    QHBoxLayout *horizontalLayout_2;
    QVBoxLayout *verticalLayout_3;
    QLabel *labelTitle3;
    QLabel *labelPendingmnsc;
    QSpacerItem *horizontalSpacer_3;
    QVBoxLayout *verticalLayout_4;
    QLabel *labelTitle4;
    QLabel *labelImmaturemnsc;
    QLabel *label_9;
    QVBoxLayout *verticalLayout_8;
    QVBoxLayout *verticalLayout;
    QLabel *labelTitle2;
    QLabel *labelAmountzmnsc;
    QHBoxLayout *horizontalLayout;
    QVBoxLayout *verticalLayout_5;
    QLabel *labelTitle5;
    QLabel *labelPendingzmnsc;
    QSpacerItem *horizontalSpacer_4;
    QVBoxLayout *verticalLayout_6;
    QLabel *labelTitle6;
    QLabel *labelImmaturezmnsc;
    ...
    void setupUi(QWidget *TopBar)
    {
        ...
        labelAmountTopmnsc = new QLabel(widgetTopAmount);
        labelAmountTopmnsc->setObjectName(QStringLiteral("labelAmountTopmnsc"));
        labelAmountTopmnsc->setMinimumSize(QSize(0, 36));
        labelAmountTopmnsc->setStyleSheet(QStringLiteral("padding:0px;margin:0px;"));

        horizontalLayout_5->addWidget(labelAmountTopmnsc, 0, Qt::AlignTop);
        ...
        label_16->setStyleSheet(QLatin1String("background-color:#0e192b;\n"
"padding:0px;\n"
"border:none;"));
        ...
        labelAmountTopzmnsc = new QLabel(widgetTopAmount);
        labelAmountTopzmnsc->setObjectName(QStringLiteral("labelAmountTopzmnsc"));
        labelAmountTopzmnsc->setMinimumSize(QSize(0, 36));

        horizontalLayout_5->addWidget(labelAmountTopzmnsc, 0, Qt::AlignTop);
        ...
        labelAmountmnsc = new QLabel(bottom_container);
        labelAmountmnsc->setObjectName(QStringLiteral("labelAmountmnsc"));

        verticalLayout_2->addWidget(labelAmountmnsc);
        ...
        labelPendingmnsc = new QLabel(bottom_container);
        labelPendingmnsc->setObjectName(QStringLiteral("labelPendingmnsc"));

        verticalLayout_3->addWidget(labelPendingmnsc);
        ...
        labelImmaturemnsc = new QLabel(bottom_container);
        labelImmaturemnsc->setObjectName(QStringLiteral("labelImmaturemnsc"));

        verticalLayout_4->addWidget(labelImmaturemnsc);
        ...
        label_9->setStyleSheet(QLatin1String("background-color:#0e192b;\n"
"padding:0px;\n"
"border:none;"));
        ...
        labelAmountzmnsc = new QLabel(bottom_container);
        labelAmountzmnsc->setObjectName(QStringLiteral("labelAmountzmnsc"));

        verticalLayout->addWidget(labelAmountzmnsc);
        ...
        labelPendingzmnsc = new QLabel(bottom_container);
        labelPendingzmnsc->setObjectName(QStringLiteral("labelPendingzmnsc"));

        verticalLayout_5->addWidget(labelPendingzmnsc);
        ...
        labelImmaturezmnsc = new QLabel(bottom_container);
        labelImmaturezmnsc->setObjectName(QStringLiteral("labelImmaturezmnsc"));

        verticalLayout_6->addWidget(labelImmaturezmnsc);
    ...
    void retranslateUi(QWidget *TopBar)
    {
        ...
        labelAmountTopmnsc->setText(QApplication::translate("TopBar", "480.0685 MNSC", Q_NULLPTR));
        label_16->setText(QString());
        labelAmountTopzmnsc->setText(QApplication::translate("TopBar", "1,000 zMNSC", Q_NULLPTR));
        labelTitle1->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountmnsc->setText(QApplication::translate("TopBar", "480.0685 MNSC", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingmnsc->setText(QApplication::translate("TopBar", "6.943 MNSC", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmaturemnsc->setText(QApplication::translate("TopBar", "10 MNSC", Q_NULLPTR));
        label_9->setText(QString());
        labelTitle2->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountzmnsc->setText(QApplication::translate("TopBar", "1,000 zMNSC", Q_NULLPTR));
        labelTitle5->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingzmnsc->setText(QApplication::translate("TopBar", "60 zMNSC", Q_NULLPTR));
        labelTitle6->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmaturezmnsc->setText(QApplication::translate("TopBar", "10 zMNSC", Q_NULLPTR));
