...
#include "qt/mnsavings/contactsdropdown.h"
#include "qt/mnsavings/sendmultirow.h"
#include "qt/mnsavings/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(MNSAVINGSGUI* parent);
    ~SendWidget();
...
private slots:
    void onMNSCSelected(bool _isMNSC);
    void onSendClicked();
...
private:
    ...
    bool sendZmnsc(QList<SendCoinsRecipient> recipients);
