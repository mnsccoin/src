...
#include "qt/mnsavings/forms/ui_coldstakingwidget.h"
#include "qt/mnsavings/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/mnsavings/requestdialog.h"
#include "qt/mnsavings/tooltipmenu.h"
#include "qt/mnsavings/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(MNSAVINGSGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your MNSCs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept MNSC delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select MNSC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 MNSC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
