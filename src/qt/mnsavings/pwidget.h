...
#include <QWidget>
#include <QString>
#include "qt/mnsavings/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(MNSAVINGSGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    MNSAVINGSGUI* getWindow() { return this->window; }
