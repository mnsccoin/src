    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of mnsc earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 mnsc");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair mnsc
