...
#ifndef MNSAVINGS_QT_WALLETMODEL_H
#define MNSAVINGS_QT_WALLETMODEL_H
...
/** Interface to MNSAVINGS wallet from Qt view code. */
...
#endif // MNSAVINGS_QT_WALLETMODEL_H
