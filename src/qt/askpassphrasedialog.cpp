...
#include "qt/mnsavings/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR MNSC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                MNSAVINGSGUI* window = static_cast<MNSAVINGSGUI*>(parentWidget());
...
{
    MNSAVINGSGUI* gui = static_cast<MNSAVINGSGUI*>(parentWidget());
...
{
    hide();
    static_cast<MNSAVINGSGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MNSAVINGS will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MNSCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
