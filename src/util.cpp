...
const char * const PIVX_CONF_FILENAME = "mnsc.conf";
const char * const PIVX_PID_FILENAME = "mnsc.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\mnsc
// Windows >= Vista: C:\Users\Username\AppData\Roaming\mnsc
// Mac: ~/Library/Application Support/mnsc
// Unix: ~/.mnsc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "mnsc";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty mnsc.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=9956\naddnode=seed1.mnsaving.com:9955\naddnode=seed2.mnsaving.com:9955\naddnode=seed3.mnsaving.com:9955\naddnode=seed4.mnsaving.com:9955\naddnode=seed5.mnsaving.com:9955\naddnode=seed6.mnsaving.com:9955\naddnode=seed7.mnsaving.com:9955\naddnode=seed8.mnsaving.com:9955\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override mnsc.conf
