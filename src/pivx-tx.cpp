...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("mnsc mnsc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnsc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnsc transaction") + "\n" +
                               "  mnsc-tx [options] -create [commands]   " + _("Create hex-encoded mnsc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnsc transaction
