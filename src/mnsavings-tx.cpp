...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("mnsc Coin mnsavings-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnsavings-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnsavings transaction") + "\n" +
                               "  mnsavings-tx [options] -create [commands]   " + _("Create hex-encoded mnsavings transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnsavings transaction
