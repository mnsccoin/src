// Copyright (c) 2017-2018 The MNSAVINGS developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MNSAVINGS_ZMNSCWALLET_H
#define MNSAVINGS_ZMNSCWALLET_H
...
public:
    CzMNSCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMNSC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMNSC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
