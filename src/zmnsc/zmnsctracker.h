...
#ifndef MNSAVINGS_ZMNSCTRACKER_H
#define MNSAVINGS_ZMNSCTRACKER_H
...
public:
    CzMNSCTracker(std::string strWalletFile);
    ~CzMNSCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMNSCWallet* zMNSCWallet = NULL);
...
#endif //MNSAVINGS_ZMNSCTRACKER_H
