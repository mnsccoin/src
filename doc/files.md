...
mnsc.conf           | contains configuration settings for mnscd or mnsc-qt
mnscd.pid           | stores the process id of mnscd while running
...
debug.log           | contains debug information and general logging generated by mnscd or mnsc-qt
